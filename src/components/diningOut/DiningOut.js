...
import { RiArrowUpDownFill, RiPinDistanceFill } from "react-icons/ri";
import { GiSettingsKnobs, GiAbacus } from "react-icons/gi";
...
const diningFilters = [
  ...
  },
  {
    id: 2,
    title: "Pro Offers",
    icon: <RiArrowUpDownFill className="fi fi-rr-angle-down absolute-center" />,
  },
  {
    id: 3,
    title: "Distance",
  ...
  },
  {
    id: 7,
    title: "Cuisines",
    icon: <GiAbacus className="fi fi-rr-angle-down absolute-center" />,
  },
  {
    id: 8,
    title: "Cafes",
...
const DiningOut = () => {
  return (
    <div>
      ...
      <ExploreSection list={diningList} collectionName="Dine-out in Gwalior" />
    </div>
  );
};
